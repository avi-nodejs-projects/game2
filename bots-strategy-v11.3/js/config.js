...
const arenaConfig = {
  enabled: true,
  dayNight: { cycleDuration: 54000 },
  particles: { poolSize: 300 },
  shake: { maxIntensity: 6 },
  director: { enabled: false, minShotDuration: 120, transitionFrames: 30 },
  terrain: {
    baseColor1: '#5a7a3a',
    baseColor2: '#3d5a27',
    textureSize: 512
  ...
  sky: {
    dawn:    { skyTop: '#ff9966', skyBottom: '#ffccaa', fieldTint: 'rgba(255,180,100,0.08)' },
    day:     { skyTop: '#87CEEB', skyBottom: '#c8e6ff', fieldTint: 'rgba(0,0,0,0)' },
    dusk:    { skyTop: '#8b5cf6', skyBottom: '#ff6b35', fieldTint: 'rgba(180,100,255,0.06)' },
    night:   { skyTop: '#0a1628', skyBottom: '#1a2744', fieldTint: 'rgba(0,0,40,0.25)' },
    predawn: { skyTop: '#1a2744', skyBottom: '#ff9966', fieldTint: 'rgba(0,0,20,0.12)' }
  },
  vegetation: { tuftsPerDot: 3, wiltFrames: 60, regrowFrames: 120 }
};
